...
/**
 * IK简易查询表达式解析 结合SWMCQuery算法 表达式例子 ： (id='1231231' && title:'monkey') ||
 * (content:'你好吗' || ulr='www.ik.com') - name:'helloword'
 *
 * @author linliangyi
 */
public class IKQueryExpressionParser {
     ...
     */
    public Query parseExp(String expression, boolean quickMode) throws ParseException {
     ...
     * @throws ParseException
     */
    private void parseSyntax(boolean quickMode) throws ParseException {
